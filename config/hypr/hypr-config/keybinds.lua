...
hl.bind("CTRL + " .. mainMod .. " + PRINT",
  hl.dsp.exec_cmd("hyprshot -m window --clipboard-only -o $HOME/Pictures/Screenshots"))
...
-- Discord global mute toggle:
-- ponytail: toggle-mute only; true hold-PTT needs Discord on XWayland + pass bind.
hl.bind("ALT_R", hl.dsp.send_shortcut({ mods = "CTRL SHIFT", key = "M", window = "class:^([Dd]iscord)$" }))
